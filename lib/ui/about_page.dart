      ...
      child: Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            ...
            Center(
              child: Text(
                "https://github.com/BSPTechnologies",
                style: TextStyle(fontSize: 14.0),
              ),
            ),
            Center(
            ...
            Center(
              child: Padding(
                ...
                child: GestureDetector(
                  onTap: _launchNewsApiURL,
                  child: Text(
                    "Disclaimer: FlipFlut is based on the idea developed by BSPTechno of news browsing"
                        "by flipping through pages. The app has been built with a demo "
                        "purpose using the Flutter cross platform SDK from Google. "
                        "Its full source code can be found at: 'https://github.com/BSPTechnologies'.",
                    style: TextStyle(fontSize: 14.0),
                  ),
                ),
              ),
